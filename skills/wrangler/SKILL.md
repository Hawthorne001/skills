...
- First inspect how the user manages production domains and deployments. Configure Previews through the same source of truth, such as Wrangler, the dashboard, Terraform, Workers Builds, or external CI, unless the user requests a different workflow. Mirror the management approach, not production resource bindings or data.
